          ...
          <div className="bg-gradient-card rounded-2xl shadow-strong p-8 border border-border/50">
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <Link to="/recuperar-senha" className="text-primary hover:text-primary-hover text-sm font-medium">
                  Esqueci minha senha
                </Link>
              </div>
              ...
              <div className="text-center space-y-2">
                <p className="text-muted-foreground text-sm">
                  Não tem uma conta?{" "}
                  <Link to="/cadastrar" className="text-primary hover:text-primary-hover font-medium">
                    Cadastre-se
                  </Link>
                </p>
